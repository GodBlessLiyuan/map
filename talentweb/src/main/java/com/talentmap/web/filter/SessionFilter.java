package com.talentmap.web.filter;
...
public class SessionFilter implements Filter {
    ...
    private static final String CONTEXT_PATH = "/mgr";
    //不需要登录就可以访问的路径，如登录页面
    String[] excludeUrls = new String[]{"/login", "/entry", "/checkCode", "/", "/favicon.ico", "/test/updateChina"};
        ...
        if (!needFilter) {
            ...
            if (session != null && session.getAttribute("phone") != null) {
                ...
                if (requestType != null && "XMLHttpRequest".equals(requestType)) {
                    ...
                    response.getWriter().write("{\"status\": 1005}");
